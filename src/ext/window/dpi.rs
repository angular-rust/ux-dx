use crate::ext::math::{Size, Vector};
...
impl LogicalPosition {
    pub fn from_physical(
        ...
        let logical_position =
            winit::dpi::LogicalPosition::from_physical(physical_position, scale_factor as f64);
...
impl PhysicalPosition {
    pub fn from_logical(logical_position: impl Into<LogicalPosition>, scale_factor: f32) -> Self {
        ...
        let physical_position =
            winit::dpi::PhysicalPosition::from_logical(logical_position, scale_factor as f64);
...
impl LogicalSize {
    pub fn from_physical(physical_size: impl Into<PhysicalSize>, scale_factor: f32) -> Self {
        ...
        let logical_size =
            winit::dpi::LogicalSize::from_physical(physical_size, scale_factor as f64);
...
impl PhysicalSize {
    pub fn from_logical(logical_size: impl Into<LogicalSize>, scale_factor: f32) -> Self {
        ...
        let physical_size =
            winit::dpi::PhysicalSize::from_logical(logical_size, scale_factor as f64);
