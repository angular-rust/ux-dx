...
use crate::platform::core::{
    Instance, PresentMode, SurfaceConfiguration, TextureFormat, TextureUsages,
};
...
use super::{
    ...
    ActivityHost, ApplicationSettings,
};
...
impl Application {
    ...
    {
        log::info!("starting \"{}\"", settings.title);
        ...
        let mut app = D::init(&mut runner, &mut store, &mut context)
        ...
        event_loop.run(move |event, _, control_flow| match event {
            Event::WindowEvent {
                ...
                app.before_event(&mut runner, &mut context, &event);
                ...
                match event {
                    ...
                    WindowEvent::CloseRequested => {
                        ...
                        *control_flow = app.close(&mut runner, &mut context);
                    }

                    WindowEvent::Destroyed => {
                        // The window has been destroyed.
                        app.destroyed(&mut runner, &mut context);
                    }
                    ...
                    WindowEvent::DroppedFile(path) => {
                        ...
                        // separately.
                        app.dropped_file(&mut runner, &mut context, path);
                    }
                    ...
                    WindowEvent::HoveredFile(path) => {
                        ...
                        // separately.
                        app.hovered_file(&mut runner, &mut context, path);
                    }
                    WindowEvent::HoveredFileCancelled => {
                        ...
                        // hovered.
                        app.hovered_file_cancelled(&mut runner, &mut context);
                    }
                    ...
                    WindowEvent::Focused(is_focused) => {
                        ...
                        app.focused(&mut runner, &mut context, *is_focused);
                    }
                    WindowEvent::KeyboardInput {
                        ...
                        *control_flow = app.keyboard_input(
                            &mut runner,
                            &mut context,
                            device_id,
                            input,
                    ...
                    WindowEvent::CursorMoved {
                        ...
                        app.cursor_moved(&mut runner, &mut context, device_id, position);
                    }
                    ...
                    WindowEvent::CursorLeft { device_id } => {
                        ...
                        app.cursor_left(&mut runner, &mut context, device_id);
                    }
                    WindowEvent::MouseWheel {
                        ...
                        app.mouse_wheel(&mut runner, &mut context, device_id, delta, phase);
                    }
                    WindowEvent::MouseInput {
                        ...
                        app.mouse_input(&mut runner, &mut context, device_id, state, button);
                    }
                    ...
                    WindowEvent::AxisMotion {
                        ...
                        app.axis_motion(&mut runner, &mut context, device_id, axis, *value);
                    }
                    WindowEvent::Touch(touch) => {
                        // Touch event has been received
                        app.touch(&mut runner, &mut context, touch);
                    }
                    ...
                    WindowEvent::ThemeChanged(theme) => {
                        ...
                        app.theme_changed(&mut runner, &mut context, theme);
                    }
                }

                // route to external handlers
                app.after_event(&mut runner, &mut context, &event);
            }
            ...
            Event::RedrawRequested(window_id) if window_id == window.id() => {
                ...
                let redraw = app.render(&mut runner, &mut context, time);
