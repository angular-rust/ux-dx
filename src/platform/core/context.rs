...
pub struct ContextProps {
    ...
    // This defines a list of fn pointers that  uses from
...
impl Context {
    ...
    /// `Context::new` then this fn returns a pointer to the
    ...
    /// `Display::new` or `Context::new` then this fn returns
