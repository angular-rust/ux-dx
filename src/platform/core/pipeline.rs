...
impl Pipeline {
    ...
    pub fn alpha_test_fn(&self) -> PipelineAlphaFunc {
        // Pipeline *authority;
    ...
    pub fn ambient(&self, ambient: &mut Color) {
        // Pipeline *authority;
    ...
    ///
    /// Status: Unstable
    pub fn cull_face_mode(&self) -> PipelineCullFaceMode {
    ...
    pub fn diffuse(&self, diffuse: &mut Color) {
        // Pipeline *authority;
    ...
    pub fn emission(&self, emission: &mut Color) {
        // Pipeline *authority;
    ...
    /// is considered to be front or back facing. This fn specifies
    ...
    ///
    /// Status: Unstable
    pub fn front_face_winding(&self) -> Winding {
        // PipelineState state = PIPELINE_STATE_CULL_FACE;
        // Pipeline *authority;
    ...
    ///  specified layer.
    pub fn layer_mag_filter(&self, layer_index: i32) -> PipelineFilter {
    ...
    ///  specified layer.
    pub fn layer_min_filter(&self, layer_index: i32) -> PipelineFilter {
        // PipelineFilter min_filter;
        // PipelineFilter mag_filter;
    ...
    pub fn layer_point_sprite_coords_enabled(&self, layer_index: i32) -> bool {
        // PipelineLayerState       change =
        //     PIPELINE_LAYER_STATE_POINT_SPRITE_COORDS;
        // PipelineLayer *layer;
        ...
        // FIXME: we shouldn't ever construct a layer in a getter fn */
    ...
    pub fn layer_texture(&self, layer_index: i32) -> Option<Texture> {
        // PipelineLayer *layer =
    ...
    /// this layer.
    pub fn layer_wrap_mode_p(&self, layer_index: i32) -> PipelineWrapMode {
        // PipelineLayer *layer;
    ...
    /// this layer.
    pub fn layer_wrap_mode_s(&self, layer_index: i32) -> PipelineWrapMode {
        // PipelineLayer *layer;
    ...
    /// this layer.
    pub fn layer_wrap_mode_t(&self, layer_index: i32) -> PipelineWrapMode {
        // PipelineLayer *layer;
    ...
    pub fn per_vertex_point_size(&self) -> bool {
        // Pipeline *authority;
    ...
    pub fn specular(&self, specular: &mut Color) {
        // Pipeline *authority;
    ...
    ///
    /// This fn will always return a valid integer. Ie, unlike
    ...
    //pub fn user_program(&self) -> /*Unimplemented*/Option<Handle> {
    ...
    /// alpha value. This fn lets you change the fn used to evaluate
    ...
    /// ## `alpha_reference`
    /// A reference point that the chosen alpha fn uses
    ///  to compare incoming fragments to.
    pub fn set_alpha_test_fn(&self, alpha_func: PipelineAlphaFunc, alpha_reference: f32) {
        // _pipeline_set_alpha_test_fn (pipeline, alpha_func);
    ...
    /// it is possible for this fn to fail and report an `error`.
    ///
    /// ## `state`
    /// A `DepthState` struct
    ///
    ...
    pub fn set_depth_state(&self, state: &DepthState) -> bool {
        ...
        //     orig_state->test_fn == depth_state->test_fn &&
    ...
    /// description then you can use this fn to define its value.
    ///
    /// ## `layer_index`
    ...
    /// This fn lets you set a matrix that can be used to e.g. translate
    ...
    ///
    /// This fn is mostly useful if you want to create a base
    /// pipeline that you want to create multiple copies from using
    /// `Pipeline::copy`. In that case this fn can be used to
    ...
    ///
    /// This fn will only work if `FeatureID::OglFeatureIdPointSprite` is
    /// available. If the feature is not available then the fn will
    ...
    /// this is not available then the fn will return `false` and set
    /// a `Error`.
    ///
    /// ## `enable`
    ...
    ///
    /// This fn should be used to set uniforms that are of type
    ...
    /// uniform by calling `Pipeline::get_uniform_location`.
    ///
    /// This fn can be used to set any floating point type uniform,
    ...
    /// uniform by calling `Pipeline::get_uniform_location`.
    ///
    /// This fn can be used to set any integer type uniform,
    ...
    /// uniform by calling `Pipeline::get_uniform_location`.
    ///
    /// This fn can be used to set any matrix type uniform, including
